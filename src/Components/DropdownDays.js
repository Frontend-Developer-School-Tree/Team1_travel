...
const DropdownDays = ({title,desc,day}) => {
                ...
                <div>
                   {desc.map((el,i)=>{
                     return <div className="" key={i}>
                          <div className="row contday">
                                <div className="col-md-1 dots">
                                    
                                   <Timeline day={day[i]+1}/>
                            ...
                            <div className="row mt-5">
                                {el.included ? <div className="include col-md-6"><i style={{backgroundColor:"#B0EED3",color:"#3ABE8A",fontSize:40,borderRadius:"100%"}} className="far fa-check-circle"></i><p style={{color:"green"}}>{el.included}</p></div> : null}
                                {el.notIncluded ? <div className="notinclude col-md-6"><i style={{backgroundColor:"#FDD1DA",color:"#BF6275",fontSize:40,borderRadius:"100%"}} className="far fa-times-circle"></i> <p style={{color:"red"}}>{el.notIncluded}</p></div> : null}
                            </div>    
                                    </div>
                                </div>
